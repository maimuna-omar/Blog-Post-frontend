...
function CreatePost() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4"> {/* Adjusted these classes */}
            <div className="rounded-md bg-white shadow-lg p-6 w-full md:max-w-2xl">
